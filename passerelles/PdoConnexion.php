...
class PdoConnexion {
    ...
    public static function getPdoDistributeur() {
        if (PdoDistributeur::$objPdoDistributeur == null) {
            PdoDistributeur::$objPdoDistributeur = new PdoDistributeur();
        }
        return PdoDistributeur::$objPdo;
    }
