...
<div class="stage-detail-container">
    ...
    <div class="stage-detail-header">
        <img src="assets/images/logoStartDev.png" alt="Logo StartDev" class="stage-logo">
        <div>
            <h1>StartDev</h1>
            <span class="badge-annee">1ère année</span>
            <p class="stage-periode">1er semestre</p>
        </div>
    </div>
    ...
    <div class="stage-section">
        ...
        <ul>
            <li>Mise en place d'un comparatif de CMS afin de choisir la solution la plus adaptée</li>
            <li>Effectuer les modifications pour répondre aux besoin du client</li>
        </ul>
    </div>
